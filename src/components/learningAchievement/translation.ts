...
const learningAchievementMessages = {
  ...
  ProgramSummaryCard: defineMessages({
    programInProgress: { id: 'learningAchievement.ProgramSummaryCard.programInProgress', defaultMessage: 'Program In Progress' },
  ...
  ProgressBarCard: defineMessages({
    learningMarathon:{ id: 'learningAchievement.ProgressBarCard.learningMarathon', defaultMessage: "Learning Marathon"},
  ...
  ProgramProgressDetailCard: defineMessages({
    progress:{ id: 'learningAchievement.ProgramProgressDetailCard.progress', defaultMessage: "Learning Progress per Program"},
  ...
  BadgeCard: defineMessages({
    ...
    updateEveryDay:{ id: 'learningAchievement.BadgeCard.updateEveryDay', defaultMessage: "※Update data at {time} every day"},
    updateEveryWeek:{ id: 'learningAchievement.BadgeCard.updateEveryWeek', defaultMessage: "※Update data every Monday"},
    rule:{ id: 'learningAchievement.BadgeCard.rule', defaultMessage: "※Medal acquisition rules: within the specified time period, the cumulative learning time of the last week is more than 60 minutes"},
  }),
  Badge: defineMessages({
    ...
    completedProgramMin:{ id: 'learningAchievement.Badge.completedProgramMin', defaultMessage: "Completed Program {mins} mins"},
    completedSingleProgramPercent:{ id: 'learningAchievement.Badge.completedSingleProgramPercent', defaultMessage: "completed Single Program Percent"},
    learningMins:{ id: 'learningAchievement.Badge.learningMins', defaultMessage: "learning {mins} mins"},
    cumulativeTimeLastWeek:{ id: 'learningAchievement.Badge.cumulativeTimeLastWeek', defaultMessage: "learning {mins} mins"},

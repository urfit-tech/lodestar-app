...
export const commonMessages = {
  ...
  button: defineMessages({
    ...
    myPage: { id: 'common.button.myPage', defaultMessage: '我的課程' },
  ...
  unit: defineMessages({
    ...
    perMonth: { id: 'common.unit.month.per', defaultMessage: '每月' },
    perYear: { id: 'common.unit.year.per', defaultMessage: '每年' },

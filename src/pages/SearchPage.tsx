...
const SearchResultBlock: React.FC<{
  ...
  const memberRoles = Number(settings['search.general_member_result.enabled'])
    ? ['content-creator', 'general-member']
    : ['content-creator']

  console.log('Calculated memberRoles:', memberRoles)
  console.log('Filter object:', { title, tag })

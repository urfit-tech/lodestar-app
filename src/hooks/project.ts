  ...
  const project: ProjectProps | null =
    loading || error || !data || !data.project_by_pk
      ...
      : {
          ...
          template: data.project_by_pk.template || null,
          ...
          projectSections: data.project_by_pk.project_sections.map(ps => ({
            id: ps.id,
            type: ps.type,
            options: ps.options,
          })),

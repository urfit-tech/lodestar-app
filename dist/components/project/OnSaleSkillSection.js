...
var OnSaleSkillSection = function (_a) {
    var cards = _a.cards, header = _a.header;
    return (React.createElement(StyledSection, null,
        React.createElement("div", { className: "container" },
            React.createElement("div", { className: "wrapper" },
                React.createElement(StyledHeader, null,
                    React.createElement("h3", null,
                        React.createElement("span", null, header.title1),
                        React.createElement("span", null, header.title2)),
                    React.createElement("h4", null, header.subtitle)),
                React.createElement(Responsive.Default, null,
                    React.createElement(StyledCarousel, { dots: true, draggable: true, slidesToShow: 3, slidesToScroll: 1, variableWidth: true }, cards.map(function (card) { return (React.createElement(StyledSlide, { key: card.title },
                ...
                React.createElement(Responsive.Desktop, null,
                    React.createElement("div", { className: "container d-flex flex-row flex-wrap justify-content-between" }, cards.map(function (card) { return (React.createElement(StyleCard, { key: card.title + card.description },
                        React.createElement(StyledCardWrapper, null,
                            React.createElement("img", { src: card.icon, alt: "card icon" }),
                            React.createElement("div", null,
                                React.createElement("h5", null, card.title),
...
//# sourceMappingURL=OnSaleSkillSection.js.map
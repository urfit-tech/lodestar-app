...
var OnSaleRoadmapSection = function (_a) {
    var roadmaps = _a.roadmaps;
    return (React.createElement(StyledSection, { className: "d-flex justify-content-center align-items-center" },
        React.createElement(StyledWrapper, { className: "container" },
            React.createElement("div", { className: "row" }, roadmaps.map(function (roadmap) { return (React.createElement(StyledRoadmap, { key: roadmap.header, className: "col-12 col-lg-6" },
                React.createElement(StyledHeader, null, roadmap.header),
                React.createElement("div", { className: "row" }, roadmap.steps.map(function (step) { return (React.createElement("div", { key: step.title, className: "col-12 col-lg-6" },
...
//# sourceMappingURL=OnSaleRoadmapSection.js.map
...
export var checkoutMessages = {
    ...
    form: {
        label: defineMessages({
            ...
            name: { id: 'checkout.form.label.name', defaultMessage: '姓名' },
            email: { id: 'checkout.form.label.email', defaultMessage: '聯絡信箱' },
            phone: { id: 'checkout.form.label.phone', defaultMessage: '手機' },
            ...
            invoice: { id: 'checkout.form.label.invoice', defaultMessage: '發票' },
            invoiceType: { id: 'checkout.form.label.invoiceType', defaultMessage: '發票類型' },
            electronicInvoice: { id: 'checkout.form.label.electronicInvoice', defaultMessage: '個人' },
            uniformNumberInvoice: { id: 'checkout.form.label.uniformNumberInvoice', defaultMessage: '公司' },
            donateInvoice: { id: 'checkout.form.label.donateInvoice', defaultMessage: '捐贈' },
            hardcopyInvoice: { id: 'checkout.form.label.hardcopy', defaultMessage: '個人' },
            hardcopyUniformNumberInvoice: { id: 'checkout.form.label.hardcopyUniformNumberInvoice', defaultMessage: '公司' },
            sendToEmail: { id: 'checkout.form.label.sendToEmail', defaultMessage: '寄送至電子信箱' },
            usePhoneBarCode: { id: 'checkout.form.label.usePhoneBarCode', defaultMessage: '使用手機條碼' },
            citizenCode: { id: 'checkout.form.label.citizenCode', defaultMessage: '自然人憑證條碼' },
            phoneBarCode: { id: 'checkout.form.label.phoneBarCode', defaultMessage: '手機條碼' },
            uniformNumber: { id: 'checkout.form.label.uniformNumber', defaultMessage: '統一編號' },
            uniformTitle: { id: 'checkout.form.label.uniformTitle', defaultMessage: '發票抬頭' },
            postCode: { id: 'checkout.form.label.postCode', defaultMessage: '郵遞區號' },
        }),
        message: defineMessages({
            couponTitle: { id: 'checkout.coupon.form.message.title', defaultMessage: '請輸入折價方案名稱' },
            errorName: { id: 'checkout.form.message.errorName', defaultMessage: '請輸入姓名' },
            email: { id: 'checkout.form.message.email', defaultMessage: '聯絡信箱' },
            errorEmail: { id: 'checkout.form.message.errorEmail', defaultMessage: '信箱格式錯誤' },
            phone: { id: 'checkout.form.message.phone', defaultMessage: '手機' },
            errorPhone: { id: 'checkout.form.message.errorPhone', defaultMessage: '手機格式錯誤' },
            ...
            warningEmail: {
                id: 'checkout.form.message.warningEmail',
                defaultMessage: '請填寫真實資料，填寫後不可更改，僅供發票與相關聯繫使用。',
            },
            warningHardcopy: {
                id: 'checkout.form.message.warningHardcopy',
                defaultMessage: '以下資訊只用於開立發票，資料填寫後不可更改。',
            },
            emailText: { id: 'checkout.text.email', defaultMessage: '請填寫電子信箱' },
            phoneBarCodeText: {
                id: 'checkout.form.message.phoneBarCode',
                defaultMessage: '長度 8 個字元，由斜線（/）加上 7 碼 +、-、.、數字及大寫字母組成',
            },
            citizenCodeText: {
                id: 'checkout.form.message.citizenCode',
                defaultMessage: '長度 16 個字元，由 2 碼大寫字母加上 14 碼數字組成',
            },
            uniformNumberText: {
                id: 'checkout.form.message.uniformNumberText',
                defaultMessage: '送出後無法更改，請務必確認',
            },
            uniformNumberRemark: {
                id: 'checkout.form.message.uniformNumberRemark',
                defaultMessage: '備註：統編發票將直接寄送至您留下的電子信箱內',
            },
            uniformTitleText: { id: 'checkout.form.message.uniformTitleText', defaultMessage: '請輸入發票抬頭' },
            ...
            sameToShipping: { id: 'checkout.form.message.sameToShipping', defaultMessage: '同寄送資訊' },
        }),
        placeholder: defineMessages({
...
export var termMessages = {
    ...
    paragraph: defineMessages({
        scope: {
            ...
            defaultMessage: '隱私權保護政策內容，包括 {name} 如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於 {name} 以外的相關連結網站，也不適用於非 {name} 所委託或參與管理的人員。',
        },
        personalData: {
            id: 'term.paragraph.personalData',
            defaultMessage: '當您造訪 {name} 或使用 {name} 所提供之功能服務時，我們將視該服務功能性質，請您提供必要的個人資料，並在該特定目的範圍內處理及利用您的個人資料；非經您書面同意， {name} 不會將個人資料用於其他用途。',
        },
        personalData2: {
            id: 'term.paragraph.personalData2',
            defaultMessage: '於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的IP位址、使用時間、使用的瀏覽器、瀏覽及點選資料記錄等，做為我們增進網站服務的參考依據，此記錄為內部應用，決不對外公佈。',
        },
        link: {
            id: 'term.paragraph.link',
            defaultMessage: '{name} 的網頁提供其他網站的網路連結，您也可經由 {name} 所提供的連結，點選進入其他網站。但該連結網站不適用 {name} 的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。',
        },
        policy: {
            id: 'term.paragraph.policy',
            defaultMessage: '{name} 絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。',
        },
        policy2: {
            id: 'term.paragraph.policy2',
            defaultMessage: '{name} 如舉辦任何回饋活動，你所提供給主辦單位的得獎連絡資料，也僅供此活動使用。{name} 不會將活動資料直接交付或售予第三方。如果 {name} 與第三方服務合作，亦應依法要求該第三方 {name} 的會員網站使用對應的約定及隱私權政策，{name} 將會盡全力保障所有會員個人資料的安全性。',
        },
        cookie: {
            id: 'term.paragraph.cookie',
            defaultMessage: '為了提供您最佳的服務， {name} 會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行。',
        },
        terms: {
            id: 'term.paragraph.terms',
            defaultMessage: '非常歡迎您使用 {name}（以下簡稱本服務），為了讓您能夠安心使用 {name} 的各項服務與資訊，特此向您說明 {name} 的隱私權保護政策，以保障您的權益，應詳細閱讀本條款所有內容。當您使用本服務時，即表示您已閱讀、了解並同意本條款所有內容。此外，因 {name} 提供多種服務，某些服務可能因其特殊之性質而有附加條款，當您開始使用該服務即視為您同意該附加條款或相關規定亦屬本條款之一部份。{name} 有權於任何時間修改或變更本條款內容，建議您隨時注意該修改或變更。當您於任何修改或變更後繼續使用本服務，視為您已閱讀、了解並同意接受該修改或變更內容。如果使⽤者不同意 {name} 對本條款進⾏的修改，請離開 {name} 網站並⽴即停⽌使⽤ {name} 服務。同時，會員應刪除個⼈檔案並註銷會員資格，{name} 亦有權刪除會員個⼈檔案並註銷會員資格。請您詳閱下列內容：',
        },
        confidentiality: {
            id: 'term.paragraph.confidentiality',
            defaultMessage: '用戶登錄資料須提供使用者本人正確、最新及完整的資料。用戶登錄資料不得有偽造、不實、冒用等之情事(如：個人資料及信用卡資料)，一經發現本公司可拒絕其加入用戶資格之權利。並得以暫停或終止其用戶資格，若違反中華民國相關法律，亦將依法追究。用戶應妥善保管密碼，不可將密碼洩露或提供給他人知道或使用；以同一個用戶身分證字號和密碼使用本服務所進行的所有行行為，都將被認為是該用戶本人和密碼持有人的行為。',
        },
        confidentiality2: {
            id: 'term.paragraph.confidentiality2',
            defaultMessage: '若使⽤者本人未滿七歲，要由使⽤者的⽗⺟或法定監護⼈申請加⼊會員。若使⽤者已滿七歲未滿⼆⼗歲，則必須在申請加⼊會員之前，請⽗⺟或法定監護⼈閱讀本條款，並得到⽗⺟或監護⼈同意後，才可以申請、註冊及使⽤ {name} 所提供的服務；當使⽤者滿⼆⼗歲之前使⽤ {name} 服務，則必須向本公司擔保已取得⽗⺟或監護⼈的同意。',
        },
        condition: {
        ...
        suspension: {
            ...
            defaultMessage: '本服務於網站相關軟硬體設備進行行更更換、升級或維修時，得暫停或中斷本服務。如因維修或不可抗力因素，導致本公司網站服務暫停，暫停的期間造成直接或間接利利益之損失，本公司不負損失賠償責任。如果本服務需有或內含可下載軟體，該軟體可能會在提供新版或新功能時，在您的裝置上自動更更新。部分情況下可以讓您調整您的自動更新設定。',
        },
        suspension2: {
            id: 'term.paragraph.suspension2',
            defaultMessage: '您使用本服務之行為若有任何違反法令或本使用條款或危害本公司或第三者權益之虞時，在法律准許範圍內，於通知或未通知之情形下，立即暫時或永久終止您使用本服務之授權。此外，使用者同意若本服務之使用被中斷或終止帳號及相關信息和文件被關閉或刪除，{name} 對使用者或任何第三人均不承擔任何責任。',
        },
        report: {
        ...
        refund1: {
            ...
            defaultMessage: '已上架的課程，學員於購買七日之內（含購買當日）認為不符合需求，且未觀看課程者（除試看單元外），可透過「聯繫客服」的方式提出退費申請。',
        },
        refund2: {
    ...
    list: defineMessages({
        item1: {
            id: 'term.list.item1',
            defaultMessage: '上載、張貼、公布或傳送任何誹謗、侮辱、具威脅性、攻擊性、不雅、猥褻、不實、違反公共秩序或善良風俗或其他不法之文字、圖片或任何形式的檔案。',
        },
        item2: {
            id: 'term.list.item2',
        ...
        item6: {
            id: 'term.list.item6',
            defaultMessage: '未經本公司明確授權同意並具書面授權同意證明，不得利用本服務或 {name} 所提供其他資源，包括但不限於圖文、影音資料庫、編寫製作網頁之軟體等，從事任何商業交易行為，或招攬廣告商或贊助人。',
        },
        item7: {
            id: 'term.list.item7',
